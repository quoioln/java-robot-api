...
public class RobotClientImpl implements RobotClient, DataPacketHandler {
	private static enum State {
		...
		OPENED_SOCKET,  			// Client opened socket, waiting for intro from srvr.  
		EXCHANGED_INTRODUCTIONS,  	// Client and server have exchanged introductions.  
		REJECTED,  					// Client was rejected by server.  
		WAITING_COMMAND_LIST,  		// Client was connected to server, waiting for list.  
		CONNECTED,  				// Client is connected to server.  
		LOST_CONNECTION  			// Client lost connection to server.  
	}
